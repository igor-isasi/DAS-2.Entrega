...
public class TareaLoginBD extends Worker {
    public TareaLoginBD(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        String direccion = "http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/iisasi021/WEB/login.php";
        ...
        try {
            ...
            // recogemos el usuario y contraseña y preparamos para mandar al php
