...
public class TareaSubirMarcadorBD extends Worker {
    public TareaSubirMarcadorBD(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        String direccion = "http://ec2-54-93-62-124.eu-central-1.compute.amazonaws.com/iisasi021/WEB/subirMarcadorBD.php";
        ...
        try {
            ...
            // recogemos el usuario y marcador y los preparamos para mandar al php
